...
const {
    zodSchemaSocketHandler,
} = require("./socket-handlers/zod-schema-socket-handler");
    ...
    io.on("connection", async (socket) => {
        ...
        socket.on("editMonitor", async (monitor, callback) => {
            try {
                ...
                bean.zodSchema = monitor.zod_schema;
