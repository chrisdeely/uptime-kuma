<template>
    <transition name="slide-fade" appear>
        <div>
                ...
                <div class="shadow-box shadow-box-with-fixed-bottom-bar">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <!-- Zod Schema -->
                            <div v-if="monitor.type === 'zod'" class="my-3">
                                <div>
                                    <label
                                        for="zod-schema"
                                        class="form-label"
            ...
            />
            <RemoteBrowserDialog
                ref="remoteBrowserDialog"
                @added="addedRemoteBrowser"
            />
            <ZodSchemaDialog ref="zodSchemaDialog" @added="addedZodSchema" />
        </div>
    </transition>
</template>
...
import ZodSchemaDialog from "../components/ZodSchemaDialog.vue";
...
export default {
    ...
    computed: {
        ...
        zodSchemaOptions() {
            return this.$root.zodSchemaList.map((schema) => {
                return {
                    label: schema.name,
                    value: schema.id,
                };
